...
def train_graph_encoder(
    ...
    max_pairs_per_class:int=100000,
    ...
    test_pairs = construct_pairs(test_dataset, max_pairs_per_class=-1)
    ...
    for train_ind,val_ind in kf.split(train_dataset,alllabs):
        ...
        training_pairs = construct_pairs(train_subset, max_pairs_per_class)
        val_pairs = construct_pairs(val_subset, max_pairs_per_class=-1)
...
def main():
    param_grid={
        ...
        'hidden_channel_dimensions':[[512,64]],
        'epochs':[200],
        'early_stopping_patience':[5],
        'max_pairs_per_class':[50000]
    }
    num_itr=20
    ...
    for ind,params in enumerate(random_params):
        ...
        train_graph_encoder(
            ...
            max_pairs_per_class=params['max_pairs_per_class'],
...
# example usage
# python -m model_training.graph_encoding_contrastive_grid --train_file_path=".pkl" --test_file_path=".pkl" --model_output_dir=".../grid_search"